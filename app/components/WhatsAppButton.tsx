    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-[max(1.25rem,env(safe-area-inset-bottom))] right-4 z-40 group sm:bottom-6 sm:right-6"
        >
          <Link
            href={href}
            target="_blank"
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                whileTap={{ scale: 0.9 }}
                className="relative bg-[#25D366] text-white w-14 h-14 sm:w-16 sm:h-16 rounded-full shadow-strong flex items-center justify-center transition-shadow hover:shadow-2xl"
              >
